...
public class QualityMetrics {
    ...
    public String toString() {
        return this.getDSC() + "\t" + this.getWMC() + "\t" + this.getDIT() + "\t" + this.getComplexity() + "\t" + this.getLCOM() + "\t" + this.getMPC() + "\t" + this.getNOM() + "\t" + this.getRFC() + "\t" + this.getDAC() + "\t" + this.getNOCC() + "\t" + this.getCBO() + "\t" + this.getSIZE1() + "\t" + this.getSIZE2();

        //return    this.getDSC() + "\t" + this.getNOH() + "\t" + this.getANA() + "\t" + this.getDAM() + "\t" + this.getDCC() + "\t" + this.getCAMC() + "\t" + this.getMOA() + "\t" + this.getMFA() + "\t" + this.getNOP() + "\t" + this.getCIS() + "\t" + this.getNPM();
